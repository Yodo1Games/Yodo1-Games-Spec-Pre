...
s.source = { :http => 'https://sdk-artifacts.yodo1.com/Yodo1Social/1.0.0-dev.5/iOS/Pre/Yodo1Social-1.0.0-dev.5.zip' }
...
sub.source_files = s.name + '/Weibo/Classes/**/*'
sub.public_header_files = s.name + '/Weibo/Classes/**/*.h'
